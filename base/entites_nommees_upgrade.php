	...
	*/
	...
	function entites_nommees_upgrade($nom_meta_base_version, $version_cible){
		...
		if ($current_version=="0.1") {
			sql_query("alter table entites_nommees add index id_article(id_article)");
			sql_query("alter table entites_nommees add index id_article_statut(id_article,statut)");
			ecrire_meta($nom_meta_base_version, "0.1");
		}
	}
