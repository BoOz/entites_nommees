	...
	protected function execute(InputInterface $input, OutputInterface $output) {
		...
		if ($spip_loaded) {
			...
			// Si c'est bon on continue
				...
				$articles = sql_query("select a.id_article from spip_articles a left join entites_nommees e on a.id_article=e.id_article where a.id_secteur=1 and e.id_article is null order by a.date_redac desc limit 0,100");
