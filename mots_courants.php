...
define("FONCTIONS_PERSONNALITES_TYPO","président de la République|chef de l'exécutif|premier ministre|président fédéral|chancelière fédérale|chef du gouvernement|reine|chancelier fédéral|première ministre|roi des Belges|roi-dragon|présidence collégiale tournante|président du conseil des ministres|président du présidium de l'Assemblée populaire suprême depuis 2011|présidente de la République|président du gouvernement|ministre d'Etat|roi|président|président du conseil|empereur|prince régnant|grand-duc|premier ministre par intérim|prince|ministre d'État");
